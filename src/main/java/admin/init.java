...
public class init extends java.awt.Frame {
    ...
    private void initComponents() {
        ...
        background.add(connectButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 200, 130, 30));
        background.add(loadingIcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 130, 50, 40));

        add(background, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 380, 300));
